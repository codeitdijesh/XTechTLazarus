...
function ProofProcessStrip({
  ...
  const steps: Array<{
  ...
  }> = [
    {
      label: "H0",
      title: "Drone leaves",
      detail: "Each drone proves its shard hash and bitmap bit.",
      unlockStep: 0,
    ...
    },
    {
      ...
      detail: "Aggregators fold child proofs without raw shard data.",
      unlockStep: 2,
    ...
    },
    {
      label: "H2",
      title: "Root proof",
      detail: "Epoch, root, bitmap, public inputs",
      unlockStep: 3,
      selection: { type: "core" },
    },
    {
      ...
      detail: "One accepted proof gates commander actions.",
      unlockStep: 4,
